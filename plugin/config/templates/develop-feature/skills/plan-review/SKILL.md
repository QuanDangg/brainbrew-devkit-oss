...
- **If requirement documents were provided: every explicit instruction is respected.** Named UI templates, referenced pages, and stated constraints must appear in the plan exactly as specified — not substituted with "similar" alternatives found by exploring the codebase.
